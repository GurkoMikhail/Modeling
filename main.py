...
size = np.asarray((51.2, 58.2, 51.2))
space = Space(size, 0)
...
collimator = Collimator((0., 7., 0.), (51.2, 51.2, 3.5), (0, np.pi/2, 0), 5, 0.15, 0.02)
space.add_subject(collimator)

detector = Detector((0., 3., 0.), (51.2, 51.2, 3), (0, np.pi/2, 0), 4)
space.add_subject(detector)

source = np.load('Phantoms/efg3.npy')
...
# modeling.source.timer = 10.
modeling.start(30, 0.01)
