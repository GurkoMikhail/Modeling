...
if __name__ == '__main__':
    collimators_list = [
        collimators.SiemensSymbiaTSeriesLEHR,
        collimators.SiemensSymbiaTSeriesLEAP,
        collimators.SiemensSymbiaTSeriesLEUHR,
        collimators.SiemensSymbiaTSeriesME,
        collimators.SiemensSymbiaTSeriesHE
        ]
    modelings = []
    ...
    collimator = collimators.SiemensSymbiaTSeriesLEHR(
    ...
    for collimator in collimators_list:
        ...
        collimator.coordinates[1] = detector.coordinates[1] + 0.5 + collimator.size[2]
        phantom.coordinates[1] = collimator.coordinates[1]
        source.coordinates[1] = collimator.coordinates[1]
        source._generate_coordinates_table()

        space.subjects[-1] = collimator
        ...
        modeling = Modeling(
            ...
            flow_number=4,
            file_name=f'{collimator.__class__.__name__}.hdf',
            subject=detector
            )
